...
document.addEventListener('DOMContentLoaded', function () {
  ...
  async function handleSubscribe(e) {
    ...
    try {
      const response = await fetch('https://assets.mailerlite.com/jsonp/2170745/forms/181330494966728632/subscribe', {
        method: 'POST',
        headers: {
      ...
      if (response.ok) {
        showMessage('¡Gracias! Revisa tu email para confirmar tu suscripción.', 'success');
        emailInput.value = '';
      } else {
